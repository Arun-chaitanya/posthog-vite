module.exports = {
    ...
    ignorePatterns: ['node_modules', 'plugin-server', 'dist', '.eslintrc.cjs'],
    settings: {
        react: {
            version: 'detect',
        },
    ...
    //i dont think it is required parseroptions
    parserOptions: {
        ecmaFeatures: {
            jsx: true,
        },
    ...
    plugins: ['prettier', 'react', 'cypres', '@typescript-eslint', 'no-only-tests', 'react-refresh'],
    rules: {
