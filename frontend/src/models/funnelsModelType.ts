// Generated by kea-typegen on Thu, 20 Jul 2023 10:57:49 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface funnelsModelType extends Logic {
    ...
    asyncActions: {
        ...
        loadFunnelsSuccess: (funnels: SavedFunnel[], payload?: any) => Promise<any>
        loadFunnelsFailure: (error: string, errorObject?: any) => Promise<any>
        deleteFunnel: (funnelId: number) => Promise<any>
        deleteFunnelSuccess: (funnels: SavedFunnel[], payload?: number) => Promise<any>
        deleteFunnelFailure: (error: string, errorObject?: any) => Promise<any>
        setNext: (next: any) => Promise<any>
        loadNext: () => Promise<any>
        appendFunnels: (funnels: any) => Promise<any>
    }
    defaults: {
        funnels: SavedFunnel[]
