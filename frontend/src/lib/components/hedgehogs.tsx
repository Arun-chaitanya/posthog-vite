...
const surprisedHog = '/static/hedgehog/surprised-hog.png'
const xRayHog = '/static/hedgehog/x-ray-hog.png'
const hospitalHog = '/static/hedgehog/hospital-hog.png'
const blushingHog = '/static/hedgehog/blushing-hog.png'
const laptopHog1 = '/static/hedgehog/laptop-hog-01.png'
const laptopHog2 = '/static/hedgehog/laptop-hog-02.png'
const explorerHog = '/static/hedgehog/explorer-hog.png'
const runningHog = '/static/hedgehog/running-hog.png'
const spaceHog = '/static/hedgehog/space-hog.png'
const tronHog = '/static/hedgehog/tron-hog.png'
const heartHog = '/static/hedgehog/heart-hog.png'
const starHog = '/static/hedgehog/star-hog.png'
const policeHog = '/static/hedgehog/police-hog.png'
const sleepingHog = '/static/hedgehog/sleeping-hog.png'
const builderHog1 = '/static/hedgehog/builder-hog-01.png'
const builderHog2 = '/static/hedgehog/builder-hog-02.png'
const builderHog3 = '/static/hedgehog/builder-hog-03.png'
const professorHog = '/static/hedgehog/professor-hog.png'
const supportHeroHog = '/static/hedgehog/support-hero-hog.png'
const xRayHog2 = '/static/hedgehog/x-ray-hogs-02.png'
const laptopHog3 = '/static/hedgehog/laptop-hog-03.png'
const laptopHog4 = '/static/hedgehog/laptop-hog-04.png'
const laptopHogEU = '/static/hedgehog/laptop-hog-eu.png'
const detectiveHog = '/static/hedgehog/detective-hog.png'
const mailHog = '/static/hedgehog/mail-hog.png'
const featureFlagHog = '/static/hedgehog/feature-flag-hog.png'
const experimentsHog = '/static/hedgehog/experiments-hog.png'
const listHog = '/static/hedgehog/list-hog.png'
const warningHog = '/static/hedgehog/warning-hog.png'
const readingHog = '/static/hedgehog/reading-hog.png'
const microphoneHog = '/static/hedgehog/microphone-hog.png'
